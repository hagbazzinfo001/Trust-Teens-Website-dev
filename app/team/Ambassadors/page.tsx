...
//         <div className="h-72 md:h-96 rounded-3xl bg-gray-200" />
//       </section>
...
//                   <div className="h-56 w-full rounded-xl bg-gray-200 mb-4" />
...
//           </p>
//           <Button className="bg-black text-white rounded-full px-8">Join Us today</Button>
//         </div>
//       </section>
//     </main>
//   );
