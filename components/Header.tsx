      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/impact" className={`text-sm transition-colors ${isActive('/impact')
                ? 'text-orange-500 font-medium'
                : 'hover:text-orange-500'
              }`}
            >
            ...
            <div className="relative group">
              <button className={`flex items-center gap-1 text-sm transition-colors py-2 ${isActive('/missions')
                  ? 'text-orange-500 font-medium'
                  : 'hover:text-orange-500'
                }`}
              >
            ...
            <div className="relative group">
              <button className={`flex items-center gap-1 text-sm transition-colors py-2 ${isActive('/community')
                  ? 'text-orange-500 font-medium'
                  : 'hover:text-orange-500'
                }`}>
                Community
            ...
            <div className="relative group">
              <button className={`flex items-center gap-1 text-sm transition-colors py-2 ${isActive('/team')
                  ? 'text-orange-500 font-medium'
                  : 'hover:text-orange-500'
                }`}>
                Team
