  ...
  export const mockCampaigns: Campaign[] = [
    {
      ...
      fullDescription: 'Rise & Shine is a comprehensive campaign focused on raising awareness about the significance of hygiene practices and provision of essential hygiene products and knowledge to teenagers. This initiative was held at Mohsai, where the event themed Rise and Shine helped raise awareness about the importance of hygiene practices and knowledge to support their well-being.',
