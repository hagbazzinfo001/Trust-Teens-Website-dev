export interface Hangout {
  ...
  export const mockHangout: Hangout[] = [
    {
      id: '1',
      name: 'Children’s Day Hangout',
      date: 'Sept 24',
      ...
      featuredImage: ' https://res.cloudinary.com/dd6pd8dsc/image/upload/v1768055943/Image_3_1_xwuuii.png?auto=compress&cs=tinysrgb&w=400',
      headerImage: ' https://res.cloudinary.com/dd6pd8dsc/image/upload/v1768055943/Image_3_1_xwuuii.png?auto=compress&cs=tinysrgb&w=800',
      aboutImage: 'https://res.cloudinary.com/dd6pd8dsc/image/upload/v1768055943/Image_3_1_xwuuii.png?auto=compress&cs=tinysrgb&w=300&h=100',
      impact: [
